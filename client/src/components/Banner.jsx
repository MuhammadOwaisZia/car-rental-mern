...
const Banner = () => {
  return (
    ...
    justify-between px-8 min-mid:pl-14 pt-10 bg-gradient-to-r from-[#0558FE] to-[#A9CFFF]
    max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>

        <div className='text-white'>
            <h2 className='text-3xl font-medium'>Do You Own A Elite Car?</h2>
            ...
            Enjoy stress-free passive income while your car works for you.</p>
